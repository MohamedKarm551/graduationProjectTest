...
<!--        </div>-->
        <div class="contactLinks">
            <button class="ui red "> <a href="https://eng-azhar.net/" target="_blank">الموقع الالكتروني للكلية</a>
                </button>
            <button class="ui orange ">
